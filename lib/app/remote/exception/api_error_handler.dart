import 'package:cbn_tv_usa/app/remote/model/error_response.dart';
            ...
            case DioErrorType.badResponse:
              switch (error.response!.statusCode) {
                ...
                case 503:
                  ...
                  } else if ((error.response!.data as Map)
                      .containsKey('errors')) {
                    errorDescription = error.response!.data['errors'];
                  } else if ((error.response!.data as Map)
                      .containsKey('otp_verified')) {
                    errorDescription =
                        'OTP Verified Failed Please Insert correct OTP';
                  } else if ((error.response!.data as Map)
                      .containsKey('detail')) {
